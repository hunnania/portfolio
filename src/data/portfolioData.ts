...
export const projectsData = [
  ...
  },
  {
    ...
    role: "Data Scientist",
    technologies: ["Python", "NetworkX", "PyTorch", "Sentence-BERT", "Google Colab", "Kaggle"],
    description: "Built a comprehensive graph-based recommendation system analyzing Amazon's co-purchasing network with 259K products and 1.2M purchase relationships. Applied multiple graph mining techniques including community detection and Graph Convolutional Networks, achieving 0.901 modularity with Louvain algorithm and 0.798 AUC for link prediction, successfully identifying meaningful product clusters for targeted marketing strategies.",
    imageUrl: "/amazon.png",
    presentationLink: "https://www.canva.com/design/DAGhb0ysIqs/cq5XD1YnIbNPfLaHPQz9sQ/view?utm_content=DAGhb0ysIqs&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hea63dea164",
    sourceCodeLink: "https://drive.google.com/file/d/1wl8jE9jSJtk2usj2IeQ0jKcf_nUCDClq/view?usp=sharing",
  },
  {
    code: "DS" as const,
    title: "Mario Character Detection in Video",
    role: "Computer Vision Engineer",
    technologies: ["Python", "YOLOv5", "OpenCV", "PyTorch", "Google Colab"],
    ...
    imageUrl: "/mario.jpg",
    presentationLink: "https://docs.google.com/document/d/1FmVNKmpD7EJXgbjqRf0YrP8ZjfnFZUQ6/edit?usp=sharing&ouid=101558734764973490487&rtpof=true&sd=true",
    sourceCodeLink: "https://colab.research.google.com/drive/18IWbFNvaF4RRcG4gn-x8E2H9YGmzP8Eh?usp=sharing",
    demoLink: "https://drive.google.com/drive/folders/1JeJi30VmTouscriHdHNvkk419f0LnE_F?usp=sharing",
  },
  {
    code: "DS" as const,
